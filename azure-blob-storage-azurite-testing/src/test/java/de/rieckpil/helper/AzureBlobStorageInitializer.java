...
public class AzureBlobStorageInitializer implements BeforeAllCallback {
	...
	private static final GenericContainer<?> AZURITE_CONTAINER = new GenericContainer<>("mcr.microsoft.com/azure-storage/azurite")
	...
	private void addConfigurationProperties() {
		...
		System.setProperty("de.rieckpil.azure.blob-storage.connection-string", CONTAINER_CONNECTION_STRING);
	}
